...
inline int imguiCombo(const char* pComboName, std::span<const char*> optionNames)
{
...
template <typename ID>
inline bool imguiCombo(const char* pComboName, std::span<const char*> optionNames, int& outIdx)
{
    static int currentIdx;
