...
public:
    ...
    void execute(const FrameGraphRegistry<ForwardShadowRTPass>& registry, const FrameGraphExecuteArgs& args);
    void displayGUI();
...
private:
    ...
    inline static float m_taaJitter = 0.0f;
